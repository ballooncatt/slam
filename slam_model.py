...
def setup_encoder(train_config, model_config, **kwargs):
    ...
    if len(encoder_list) == 1:
        ...
        if encoder_name == "whisper" or encoder_name == "qwen-audio":
            ...
            # model_config.encoder_path_hf="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-fsprisk/fudongjie/huggingface.co/openai/whisper-large-v3"
            model_config.encoder_path_hf="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-fsprisk/fudongjie/huggingface.co/openai/whisper-small"
...
def setup_llm(train_config, model_config, **kwargs):
    ...
    if (train_config.enable_fsdp or train_config.enable_ddp) and train_config.low_cpu_fsdp:
        ...
        elif 'llada' in model_config.llm_name.lower():
