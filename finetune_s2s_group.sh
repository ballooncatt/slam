...
export LD_LIBRARY_PATH=/mnt/dolphinfs/hdd_pool/docker/user/hadoop-fsprisk/tools/env_bk/slam/lib:$LD_LIBRARY_PATH
...
speech_encoder_path="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-fsprisk/fudongjie/huggingface.co/openai/whisper-small"   # different whisper size
llm_path="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-fsprisk/huggingface.co/Dream-org/Dream-v0-Base-7B"  # Qwen/Qwen2-0.5B, you can choose other Qwen models (Qwen2 or Qwen2.5)
llm_name=llada1.5
...
train_data_path=/mnt/dolphinfs/hdd_pool/docker/user/hadoop-fsprisk/fudongjie/huggingface.co/datasets/worstchan/VoiceAssistant-400K-SLAM-Omni/data/
val_data_path=/mnt/dolphinfs/hdd_pool/docker/user/hadoop-fsprisk/fudongjie/huggingface.co/datasets/worstchan/VoiceAssistant-400K-SLAM-Omni/data/
# train_data_path=/mnt/dolphinfs/hdd_pool/docker/user/hadoop-fsprisk/fudongjie/huggingface.co/datasets/worstchan/UltraChat-300K-SLAM-Omni/data/
# val_data_path=/mnt/dolphinfs/hdd_pool/docker/user/hadoop-fsprisk/fudongjie/huggingface.co/datasets/worstchan/UltraChat-300K-SLAM-Omni/data/
...
home_dir=/mnt/dolphinfs/hdd_pool/docker/user/hadoop-fsprisk/fudongjie/SLAM-LLM/result_400m_0812_dream_1e_4
